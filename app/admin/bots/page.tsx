...
export default function AdminBotsPage() {
  ...
  return <main className="mx-auto max-w-6xl px-4 py-10 md:px-6">
    <div className="mb-8"><span className="text-sm font-bold uppercase tracking-[.18em] text-ember">Администрирование</span><h1 className="display mt-2 text-4xl font-semibold">Модерация ботов</h1><p className="mt-2 text-sm text-stone-500">Права проверяет backend; frontend только отображает результат.</p></div>
    ...
    {state.status === "unauthorized" && <p role="alert" className="rounded-2xl border border-orange-200 bg-orange-50 p-8 text-center">Войдите в аккаунт, чтобы открыть этот экран.</p>}
